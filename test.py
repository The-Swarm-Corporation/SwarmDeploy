...
class HighSpeedExecutor:
    ...
    async def _worker(self, queue, func, *args, **kwargs):
    ...
    async def _distribute_tasks(self, num_tasks, queue):
        """Distribute tasks across the queue"""
        for i in range(num_tasks):
            await queue.put(i)

    async def execute_batch(
        self, func, num_executions, *args, **kwargs
    ):
        """
